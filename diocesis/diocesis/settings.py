"""
Django settings for diocesis project.
...
SECRET_KEY = '75&!xd^api2#np7%&0n*voad@q+8)y&b3dww42-5w)mls!i6qe'
...
WSGI_APPLICATION = 'diocesis.wsgi.application'
